...
class LocaleKeys {
  ...
  static const success_locale_generate = 'sucess_locale_generate';
  static const success_getx_pattern_generated = 'sucess_getx_pattern_generated';
  static const success_clean_Pattern_generated = 'sucess_clean_Pattern_generated';
  static const success_file_formatted = 'sucess_file_formatted';
  ...
  static const success_add_controller_in_bindings = 'sucess_add_controller_in_bindings';
  static const success_navigation_added = 'sucess_navigation_added';
  static const success_file_created = 'sucess_file_created';
  static const success_route_created = 'sucess_route_created';
...
class Locales {
  static const tr_TR = {
    ...
    'error_update_cli': 'refreshed_cli yükseltilirken bir hata oluştu',
    ...
    'hint_update': 'refreshed_cli günceller',
    ...
    'info_cli_last_version_already_installed': 'refreshed_cli\'nin son sürümü zaten yüklü',
  ...
  static const zh_CN = {
    ...
    'error_required_path': '需要传入文件或路径',
    'error_invalid_dart': '%s 不是有效的dart文件',
    ...
    'error_update_cli': '升级 refreshed_cli 错误',
    ...
    'example': '例:',
    'warning': '警告:',
    'hint_create_controller': '生成 controller',
    'hint_create_page': '用于生成 page',
    'hint_create_project': '用于生成新项目',
    'hint_create_provider': '创建一个新 Provider',
    'hint_create_screen': '生成新 Screen',
    'hint_create_view': '生成 view',
    'hint_generate_locales': '从 json 文件生成国际化翻译文件',
    'hint_generate_model': '从 json 生成 model 类',
    'hint_help': '显示本帮助',
    'hint_init': '生成所选结构在现有项目:',
    'hint_install': '为你的项目安装依赖:',
    'hint_remove': '为你的项目移除依赖:',
    'hint_sort': '排序 import 并格式化 dart 文件',
    'hint_update': '更新 refreshed_cli',
    ...
    'info_cli_last_version_already_installed': '您已安装 refreshed_cli 最新版本',
    ...
    'success_page_create': '%s page 创建成功.',
  ...
  static const de = {
    ...
    'error_update_cli': 'Es gab einen Fehler bei der Aktualisierung von refreshed_cli',
    ...
    'hint_update': 'So aktualisieren Sie refreshed_cli',
    ...
    'info_cli_last_version_already_installed': 'Neueste Version von refreshed_cli bereits installiert',
  ...
  static const en = {
    ...
    'error_update_cli': 'There was an error upgrading refreshed_cli',
    ...
    'hint_update': 'To update refreshed_cli',
    ...
    'info_cli_last_version_already_installed': 'Latest version of refreshed_cli already installed',
  ...
  static const pt_BR = {
    ...
    'error_update_cli': 'Ocorreu um erro ao atualizar refreshed_cli',
    ...
    'hint_update': 'Para atualizar refreshed_cli',
    'hint_version': 'Mostra a versão atual do refreshed_cli',
    ...
    'info_cli_last_version_already_installed': 'Versão mais recente de refreshed_cli já instalada',
    ...
    'success_page_create': 'Página %s criada comsuccesso.',
    'sucess_locale_generate': 'Arquivo de tradução gerado comsuccesso.',
    'sucess_getx_pattern_generated': 'Estrutura GetX Pattern gerada comsuccesso.',
    'sucess_clean_Pattern_generated': 'Estrutura CLEAN gerada comsuccesso.',
    'sucess_file_formatted': ' \'%s\' foi formatado comsuccesso',
    ...
    'sucess_navigation_added': '%s navigation adicionada comsuccesso.',
    'sucess_file_created': 'Arquivo: %s criado comsuccesso no path: %s',
    'sucess_route_created': 'Rota %s criada comsuccesso.',
  };
}
