...
```shell
  get create controller:auth with 'https://raw.githubusercontent.com/jonataslaw/refreshed_cli/master/samples_file/controller.dart.example' on your_folder
```
...
Você é um daqueles que prefere usar imports relativos em vez de imports de projeto, use a opção `--relative`. o refreshed_cli irá converter para você.
